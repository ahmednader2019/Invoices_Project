...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Payment Status</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Empty</span>
						</div>
					</div>
                       ...
                       @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Amount_collection" readonly value="{{$invoice->Amount_collection}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission" readonly value="{{$invoice->Amount_Commission}}"
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount"  readonly name="Discount" value="{{$invoice->Discount}}"
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">Rate Value</label>
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control"  readonly value="{{$invoice->Rate_Vat}}" onchange="myFunction()">
                                    <!--placeholder-->
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" id="Status" name="Status" required>
                                    ...
                                    <option value="مدفوعة جزئيا">Half Paid </option>
                                </select>
                            </div>
