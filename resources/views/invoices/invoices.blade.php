                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div  class="dropdown-menu tx-13">
                                                <a class="dropdown-item" href="{{url('edit_invoice')}}/{{$invoice->id}}"><i class='fas fa-user-edit' style='font-size:14px;color:red'>Edit</i>
                                                ...
                                                <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                    ...
                                                    <a class="dropdown-item" href="{{url('status_show')}}/{{$invoice->id}}" > <i
                                                        class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp; Change Payment Status</a>
                                                    <a class="dropdown-item" href="{{url('archieve_move')}}/{{$invoice->id}}" ><i
                                                        class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;Move To Archieve</a>
